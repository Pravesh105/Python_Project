...
n_l_letters = int(input("How many lower letters would you like in your password?\n")) 
n_u_letters = int(input("How many upper letters would you like in your password?\n"))
n_symbols = int(input(f"How many symbols would you like?\n"))
n_numbers = int(input(f"How many numbers would you like?\n"))

password_list = []

for char in range(1, n_l_letters + 1):
  password_list.append(random.choice(l_letters))

for char in range(1, n_u_letters + 1):
